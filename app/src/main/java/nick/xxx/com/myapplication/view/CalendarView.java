package nick.xxx.com.myapplication.view;
...
import nick.xxx.com.myapplication.R;
...
public class CalendarView extends LinearLayout{
    ...
    private void initStyle(Context context, AttributeSet attrs) {
        ...
        mTextSize = typedArray.getDimensionPixelSize(R.styleable.CalendarViewStyle_textSize, 50);
        typedArray.recycle();
    }
